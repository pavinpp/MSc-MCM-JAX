...
if __name__ == "__main__":
    ...
    # Flow rate obtained from singlephase simulation for wetting and non-wetting channel, see multiphase/2D_channel.py example for details
    Single_Q_w = [0.06216392666101456, 0.06216, 0.06216]
    Single_Q_nw = [0.06216392666101456, 0.6146253347396851, 0.006869212258607149]
